...
```bash
# Using Wget
command wget https://github.com/nalinahuja22/qcd/archive/v2.0.2.zip

# Using Curl
command curl -sL https://github.com/nalinahuja22/qcd/archive/v2.0.2.zip > v2.0.2.zip
```
